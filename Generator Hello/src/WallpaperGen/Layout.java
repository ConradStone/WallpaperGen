...
public class Layout {
	...
	private void initialize() {
		...
		themeInput.setModel(new DefaultComboBoxModel(new String[] {"Select Your Theme", "Ebola", "Corona", "Gradient"}));
		...
		colorInput.setModel(new DefaultComboBoxModel(new String[] {"Select a Primary Colour", "Red", "Orange", "Yellow", "Green", "Turquoise", "Blue", "Purple"}));
